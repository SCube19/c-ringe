...
instance Print Stmt where
  prt i e = case e of
    ...
    Decl type_ item -> prPrec i 0 (concatD [prt 0 type_, prt 0 item, doc (showString ";")])
    ConstDecl type_ item -> prPrec i 0 (concatD [doc (showString "immutable"), prt 0 type_, prt 0 item, doc (showString ";")])
    Ass id expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), prt 0 expr, doc (showString ";")])
    Incr id -> prPrec i 0 (concatD [doc (showString "inc"), prt 0 id, doc (showString ";")])
    Decr id -> prPrec i 0 (concatD [doc (showString "dec"), prt 0 id, doc (showString ";")])
    ...
    For id expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "from"), prt 0 id, doc (showString "="), prt 0 expr1, doc (showString "to"), prt 0 expr2, doc (showString "do"), prt 0 stmt])
    Print expr -> prPrec i 0 (concatD [doc (showString "print"), doc (showString "("), prt 0 expr, doc (showString ")"), doc (showString ";")])
    Break -> prPrec i 0 (concatD [doc (showString "exit"), doc (showString ";")])
    Continue -> prPrec i 0 (concatD [doc (showString "skipit"), doc (showString ";")])
...
instance Print Type where
  prt i e = case e of
    ...
    Fun -> prPrec i 0 (concatD [doc (showString "fun")])
...
instance Print RelOp where
  prt i e = case e of
    ...
    EQU -> prPrec i 0 (concatD [doc (showString "is")])
    NE -> prPrec i 0 (concatD [doc (showString "is not")])
